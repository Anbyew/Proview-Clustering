...
for ep in epp:
    for mi in mii:
        ...
        if n_clusters_ < 120:
            ...
            plt.savefig('2/DBSCAN' + str(ep) + '_' + str(mi) + '_' + str(spsz) + '.png')
            print("")



plt.plot(range(len(epp) * len(mii)), ss)
plt.savefig('2/DBSCAN' + str(ep) + '_' + str(mi) + '_' + str(spsz) + '_ss.png')
plt.plot(range(len(epp) * len(mii)), cs)
plt.savefig('2/DBSCAN' + str(ep) + '_' + str(mi) + '_' + str(spsz) + '_cs.png')